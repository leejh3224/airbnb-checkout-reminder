...
const buildMailBody = ({ title, body = "" }: Param) => {
	 ...
	 * 3. It should be base64-url encoded. Reference: https://ncona.com/2011/06/using-utf-8-characters-on-an-e-mail-subject/
	 * 4. If Subject field contains non ascii characters, then you should follow [RFC 1342](https://tools.ietf.org/html/rfc1342) format, ie. =?utf-8?B?base64EncodedBody?=
